...
const AMAZON_CONFIG = {
  ...
  GB: { domain: 'amazon.co.uk', tag: 'softywareai06-21' },
  CA: { domain: 'amazon.ca', tag: 'softywareai-20' },
  DE: { domain: 'amazon.de', tag: 'softywareai06-21' },
  FR: { domain: 'amazon.fr', tag: 'softywareai06-21' },
  ES: { domain: 'amazon.es', tag: 'softywareai06-21' },
  IT: { domain: 'amazon.it', tag: 'softywareai06-21' },
  IN: { domain: 'amazon.in', tag: 'softywareai06-21' },
  ...
  NL: { domain: 'amazon.nl', tag: 'softywareai06-21' },
  PL: { domain: 'amazon.pl', tag: 'softywareai06-21' },
  SE: { domain: 'amazon.se', tag: 'softywareai06-21' },
  TR: { domain: 'amazon.com.tr', tag: 'softywareai06-21' },
  SG: { domain: 'amazon.sg', tag: 'softywareai-22' },
  AE: { domain: 'amazon.ae', tag: 'softywareai06-21' },
  SA: { domain: 'amazon.sa', tag: 'softywareai06-21' },
  BE: { domain: 'amazon.com.be', tag: 'softywareai06-21' },
  EG: { domain: 'amazon.eg', tag: 'softywareai06-21' },
};
